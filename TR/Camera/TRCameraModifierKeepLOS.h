...
#include "TRCameraModifierKeepLOS.generated.h"
...
class TR_API UTRCameraModifierKeepLOS : public UHoatCameraModifier
{
	GENERATED_BODY()

public:
	UTRCameraModifierKeepLOS(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
